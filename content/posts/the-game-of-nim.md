...
og:
  description: >-
    An explanation of the winning strategy for the game of Nim, based on Knuth's The
    Art of Computer Programming, including the game theory behind it.
