...
[previous post](/posts/machine-learning/neural-networks/02-the-model), it becomes useful to be able to
...
The [next post](/posts/machine-learning/neural-networks/04-the-optimization-problem) will
