...
[error function](/posts/machine-learning/neural-networks/04-the-optimization-problem) $E$
differentiable.
...
[next post on back-propagation](/posts/machine-learning/neural-networks/06-back-propagation-derivation) deals with.
