...
og:
  description: >-
    ...
    multiple inputs.
redirect: /posts/neural-networks/03-multiple-inputs/
---
When considering efficient implementations of evaluating a neural network as described in the
[previous post](/posts/neural-networks/model/), it becomes useful to be able to
...
The [next post](/posts/neural-networks/the-optimization-problem/) will
