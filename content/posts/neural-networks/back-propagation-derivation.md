...
redirect: /posts/neural-networks/06-back-propagation-derivation/
---
...
We now have the [error function](/posts/neural-networks/the-optimization-problem/)
defined as
$$
...
[the definition](/posts/neural-networks/multiple-inputs/) of $Z^l_{ic}$.
Similarly for $b^l_i$:
$$
\frac{\partial E}{\partial b^l_i}
...
The [next post](/posts/neural-networks/back-propagation-matrix-style/)
