...
og:
  description: >-
    The first in a series on multiple-precision arithmetic, covering theory from
    Knuth's The Art of Computer Programming and a portable C++ implementation.
redirect: /blog/2009/07/implementing-multiple-precision-arithmetic-part-1/
---
### Introduction
...
We have now covered addition, subtraction, and multiplication of non-negative integers of arbitrary magnitude. Left is how to do division, which will be the subject of the [next article](/posts/implementing-multiple-precision-arithmetic-part-2/).
