...
An observation that can lead to faster algorithms is the fact that, as mentioned above, $\lfloor \log_2 n \rfloor$ is the position of the left-most bit. Let us address multiple-precision numbers first. Assume that a positive integer $n$ is represented as in a [previous post](/2009/07/implementing-multiple-precision-arithmetic-part-1.html) as
...
<div class="pull-right"><a href="http://www.amazon.com/gp/product/0201914654?ie=UTF8&tag=sputsoft-20&linkCode=as2&camp=1789&creative=390957&creativeASIN=0201914654"><img src="/media/books/hackers-delight.jpg" alt=""></a></div>
