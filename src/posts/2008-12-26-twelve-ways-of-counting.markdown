...
<tr>
<td>$n$ labeled balls, $m$ labeled urns</td>
<td>(1)</td>
<td>(5)</td>
<td>(9)</td>
</tr>
<tr>
<td>$n$ unlabeled balls, $m$ labeled urns</td>
<td>(2)</td>
<td>(6)</td>
<td>(10)</td>
</tr>
<tr>
<td>$n$ labeled balls, $m$ unlabeled urns</td>
<td>(3)</td>
<td>(7)</td>
<td>(11)</td>
</tr>
<tr>
<td>$n$ unlabeled balls, $m$ unlabeled urns</td>
<td>(4)</td>
<td>(8)</td>
<td>(12)</td>
</tr>
...
<tr>
<td>$n$ labeled balls, $m$ labeled urns</td>
<td>$n$-tuples of $m$ things</td>
<td>$n$-permutations of $m$ things</td>
<td>Set partitions of {1, &#8230;, $n$} into $m$ ordered parts</td>
</tr>
<tr>
<td>$n$ unlabeled balls, $m$ labeled urns</td>
<td>$n$-multicombinations of $m$ things</td>
<td>$n$-combinations of $m$ things</td>
<td>Compositions of $n$ into $m$ parts</td>
</tr>
<tr>
<td>$n$ labeled balls, $m$ unlabeled urns</td>
<td>Set partitions of {1, &#8230;, $n$} into &le; $m$ parts</td>
<td>$n$ pigeons into $m$ holes</td>
<td>Set partitions of {1, &#8230;, $n$} into $m$ parts</td>
</tr>
<tr>
<td>$n$ unlabeled balls, $m$ unlabeled urns</td>
<td>Partitions of $n$ into &le; $m$ parts</td>
<td>$n$ pigeons into $m$ holes</td>
<td>Partitions of $n$ into $m$ parts</td>
</tr>
</tbody>
</table>
